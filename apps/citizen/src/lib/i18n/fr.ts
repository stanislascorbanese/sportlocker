...
export const fr: Copy = {
  ...
  choose: {
    ...
    emptyTitle: 'La borne est vide',
    emptyHint: 'Tout est sorti pour le moment. Le matériel revient au fil de la journée — repassez un peu plus tard, ou demandez à l’accueil.',
    emptyAgain: 'Revérifier',
    footer:
  ...
  items: {
    ...
    raquette: 'Raquette',
    pingpong: 'Raquettes de ping-pong',
    badminton: 'Set de badminton',
