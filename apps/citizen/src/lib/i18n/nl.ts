...
export const nl: Copy = {
  ...
  choose: {
    ...
    emptyTitle: 'Het uitleenpunt is leeg',
    emptyHint: 'Alles is momenteel uitgeleend. Materiaal komt gedurende de dag terug — kom straks nog eens langs, of vraag het bij de receptie.',
    emptyAgain: 'Opnieuw kijken',
    footer:
  ...
  items: {
    ...
    volley: 'Volleybal',
    raquette: 'Racket',
    pingpong: 'Pingpongbatjes',
    badminton: 'Badmintonset',
    tennis: 'Tennisracket',
    disque: 'Frisbee',
    plot: 'Pionnen',
    corde: 'Springtouw',
