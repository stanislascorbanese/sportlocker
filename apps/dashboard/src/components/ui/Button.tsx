...
const VARIANT: Record<ButtonVariant, string> = {
  primary:
    ...
    'disabled:bg-brand-500/40 disabled:text-white/70',
  secondary:
...
export function buttonClassName({
  ...
  return cn(
    ...
    'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500/60 focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:focus-visible:ring-brand-500/60 dark:focus-visible:ring-offset-navy-900',
    VARIANT[variant],
    SIZE[size],
    fullWidth && 'w-full',
  )
